...
import { addTracksToPlaylist, createPlaylist } from '../components/config/fetchApi';
import Button from '../components/config/Button';
import Input from './Input';
import InputGroup from './config/InputGroup';
import './index.css';
...
export default function CreatePlaylistForm({ accessToken, userId, uriTracks }) {
    ...
    return ( <
        ...
        <
        form className = "form form-playlist"
        ...
        name = "description"
        onChange = { handleChange }
        required error = { errorForm.description }
        /> <
        /InputGroup>
